                                        ...
                                        <tbody>
                                            <tr>
                                                <td height="30" style="border-collapse: collapse;">
                                                    <h2 style="background: #fff; text-align: center; margin-bottom:0px; font-size: 24px;">Patients Consumer Enquiry</h2></td>
                                            </tr>
                                            <!--end space height -->
                                            <tr>
                                                                            ...
                                                                            <td class="column" align="left">
                                                                                <table cellpadding="10" cellspacing="10">
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td style="padding-left:10px"><strong>DOB</strong>:</td>
                                                                                            <td style="padding-left:10px">{!! $details['dob'] !!}</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td style="padding-left:10px">{!! $details['gender'] !!}</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td style="padding-left:10px"><strong>Test For Home Collection</strong>:</td>
                                                                                            <td style="padding-left:10px">{!! $details['test_for_home_collection'] !!}</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td style="padding-left:10px"><strong>Preferred Date 1</strong>:</td>
                                                                                            <td style="padding-left:10px">{!! $details['preferred_date_1'] !!}</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td style="padding-left:10px"><strong>Preferred Date 2</strong>:</td>
                                                                                            <td style="padding-left:10px">{!! $details['preferred_date_2'] !!}</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td style="padding-left:10px"><strong>Preferred Time</strong>:</td>
                                                                                            <td style="padding-left:10px">{!! $details['preferred_time'] !!}</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td style="padding-left:10px"><strong>Address</strong>:</td>
                                                                                            <td style="padding-left:10px">{!! $details['address'] !!}</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td style="padding-left:10px"><strong>Pincode</strong>:</td>
                                                                                            <td style="padding-left:10px">{!! $details['pincode'] !!}</td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                            </td>
