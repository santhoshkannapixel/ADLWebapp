                                        ...
                                        <tbody>
                                            <tr>
                                                <td height="30" style="border-collapse: collapse;">
                                                    <h2 style="background: #fff; text-align: center; margin-bottom:0px; font-size: 24px;">Hospital Lab Management Enquiry</h2></td>
                                            </tr>
                                            <!--end space height -->
                                            <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td class="column" align="left">
                                                                                <table cellpadding="10" cellspacing="10">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td style="padding-left:10px"><strong>Hospital Name</strong>:</td>
                                                                                            <td style="padding-left:10px">{!! $details['hospital_name'] !!}</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td style="padding-left:10px"><strong>Hospital Address</strong>:</td>
                                                                                            <td style="padding-left:10px">{!! $details['hospital_address'] !!}</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td style="padding-left:10px"><strong>Designation</strong>:</td>
                                                                                            <td style="padding-left:10px">{!! $details['designation'] !!}</td>
                                                                                        </tr>
                                                                                        <tr>
