                                        ...
                                        <tbody>
                                            <tr>
                                                <td height="30" style="border-collapse: collapse;">
                                                    <h2 style="background: #fff; text-align: center; margin-bottom:0px; font-size: 24px;">Clinical Lab Management Enquiry</h2></td>
                                            </tr>
                                            <!--end space height -->
                                            <tr>
                                                                        ...
                                                                        <tr>
                                                                            <td class="column" align="left">
                                                                                <table cellpadding="10" cellspacing="10">
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td style="padding-left:10px"><strong>Doctors Name</strong>:</td>
                                                                                            <td style="padding-left:10px">{!! $details['doctors_name'] !!}</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td style="padding-left:10px"><strong>Specialization</strong>:</td>
                                                                                            <td style="padding-left:10px">{!! $details['specialization'] !!}</td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td style="padding-left:10px"><strong>Associated Hospitals Clinics</strong>:</td>
                                                                                            <td style="padding-left:10px">{!! $details['associated_hospitals_clinics'] !!}</td>
                                                                                        </tr>
                                                                                        <tr>
