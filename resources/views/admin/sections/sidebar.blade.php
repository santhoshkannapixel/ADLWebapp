<div class="d-flex flex-column flex-shrink-0 text-white   side_bar" style="width: 280px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto mt-3 pt-0 p-3 side-navbar">
        ...
        @endif
        @if ( permission_check('PATIENTS_CONSUMERS_INDEX') || permission_check('HOME_COLLECTION_INDEX') || permission_check('FEEDBACK_INDEX') || permission_check('FAQ_INDEX') )
        <li>
            <a href="{{ route('home-collection.index') }}" class="nav-link text-white {{ Route::is([
                    // 'patients.index',
        ...
        @endif
        @if ( permission_check('HOSPITAL_LAB_MANAGEMENT_INDEX') || permission_check('CLINICAL_LAB_MANAGEMENT_INDEX') || permission_check('FRANCHISING_OPPORTUNITIES_INDEX') || permission_check('RESEARCH_INDEX') )
        <li>
            <a href="{{ route('hospital-lab-management.index') }}" class="nav-link text-white {{ Route::is([
                    // 'doctors.index',
        ...
        <li>
            <a href="{{ route('healthcheckup-for-employee.index') }}" class="nav-link text-white {{ Route::is([
                    // 'reach-us.index',
        ...
        @endif
        @if (permission_check('BRANCH_SYNC') || permission_check('BRANCH_SHOW') || permission_check('CITY_INDEX') || permission_check('TEST_INDEX') || permission_check('BANNER_INDEX') || permission_check('ORGAN_INDEX') || permission_check('CONDITION_INDEX')  )
        <li>
