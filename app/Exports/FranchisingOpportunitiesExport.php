...
class FranchisingOpportunitiesExport implements FromCollection, WithHeadings
{
    ...
    {
        return FranchisingOpportunities::select('name', 'email', 'mobile', 'city', 'message', 'created_at')->when(!empty($this->request->start_date) && !empty($this->request->end_date), function ($query) {
